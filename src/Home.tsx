  ...
  return (
    <div className="homePage">
      ...
      <div className="content">
        <div className="contentTitle">A better way</div>
        <div className="contentTitle">to enjoy every day.</div>
        <div className="contentSubTitle">
          Be the first to know when we launch.
        </div>
        <Button
          onClick={() => setShowInviteFlag(true)}
        >
          Request an invite
        </Button>
        <SubmitModal
          isModalVisible={showInviteFlag}
          onCancel={onClose}
          onSuccess={() => setShowResultFlag(true)}
        ></SubmitModal>
        <SubmitResult
          isModalVisible={showResultFlag}
          onOk={onClose}
        ></SubmitResult>
      </div>
